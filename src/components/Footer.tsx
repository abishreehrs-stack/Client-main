...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-surface-container-low text-on-surface border-t border-glass-border pt-16 pb-12 transition-colors duration-300">
      <div className="max-w-container-max mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-4">
          <Link href="/" className="flex items-center gap-3 group self-start">
            ...
            <div>
              <span className="font-extrabold text-xl text-primary block leading-tight">Abishree HR</span>
              <span className="text-[10px] text-on-surface-variant uppercase tracking-widest font-bold">Consultants</span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-3 pt-2">
            <a 
              ...
              className="w-9 h-9 rounded-xl bg-surface-container hover:bg-primary hover:text-on-primary border border-glass-border flex items-center justify-center text-primary transition-all shadow-sm hover:scale-105"
            >
        ...
        {/* Quick Links */}
        <div>
          <h4 className="text-xs font-extrabold text-primary uppercase tracking-wider mb-4">Quick Links</h4>
          <ul className="flex flex-col gap-2.5 text-xs sm:text-sm text-on-surface-variant">
            <li>
        ...
        {/* Core Practices */}
        <div>
          <h4 className="text-xs font-extrabold text-primary uppercase tracking-wider mb-4">Core Practices</h4>
          <ul className="flex flex-col gap-2.5 text-xs sm:text-sm text-on-surface-variant">
            <li>
              <Link href="/services" className="hover:text-primary transition-colors flex items-center gap-1.5">
        ...
        {/* Contact Info */}
        <div>
          <h4 className="text-xs font-extrabold text-primary uppercase tracking-wider mb-4">Headquarters</h4>
          <div className="flex flex-col gap-3 text-xs sm:text-sm text-on-surface-variant">
            ...
            <a href="mailto:contact@abishreehr.com" className="flex items-center gap-2.5 hover:text-primary transition-colors">
              <span className="material-symbols-outlined text-primary text-[20px] shrink-0">mail</span>
              <span>contact@abishreehr.com</span>
            </a>
            <a href="tel:+919876500112" className="flex items-center gap-2.5 hover:text-primary transition-colors">
      ...
      {/* Bottom Legal Bar */}
      <div className="max-w-container-max mx-auto px-6 mt-12 pt-6 border-t border-glass-border flex flex-col sm:flex-row items-center justify-between text-xs text-on-surface-variant gap-4">
      ...
      {legalModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="glass-card rounded-3xl max-w-xl w-full p-6 sm:p-8 flex flex-col gap-5 shadow-2xl border border-glass-border max-h-[85vh] overflow-y-auto">
            ...
            <div className="text-xs sm:text-sm text-on-surface-variant leading-relaxed flex flex-col gap-3">
              {legalModal === 'privacy' && (
                <>
            ...
            <div className="pt-3 border-t border-glass-border flex justify-end">
              <button
                onClick={() => setLegalModal(null)}
                className="bg-primary text-on-primary font-bold text-xs px-6 py-2.5 rounded-xl shadow"
              >
                Close Notice
              </button>
            </div>
