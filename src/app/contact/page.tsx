  ...
  return (
    <div className="w-full flex flex-col min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 max-w-container-max mx-auto px-6 flex flex-col items-center">
          ...
          <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl leading-relaxed mb-6">
          ...
          <div className="inline-flex items-center gap-3 glass-card px-5 py-2.5 rounded-2xl shadow-sm">
            <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse" />
            <span className="text-xs font-extrabold text-on-surface">Consultation SLA: Priority Response in &lt;4 Hours</span>
          </div>
      ...
      <section className="relative py-16 bg-surface border-b border-glass-border transition-colors duration-300 overflow-hidden">
        {/* Ambient Typographic Watermark */}
        ...
        <div className="relative z-10 max-w-container-max mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          
          <div className="glass-card rounded-3xl p-6 flex flex-col justify-between group shadow-md border border-glass-border hover:-translate-y-1 transition-all">
            ...
            <a 
              ...
              className="cursor-pointer pt-4 mt-4 border-t border-glass-border text-xs font-bold text-primary hover:underline flex items-center gap-1"
            >
              <span>executivesearch@abishreehr.com</span>
          ...
          <div className="glass-card rounded-3xl p-6 flex flex-col justify-between group shadow-md border border-glass-border hover:-translate-y-1 transition-all">
            ...
            <a 
              ...
              className="cursor-pointer pt-4 mt-4 border-t border-glass-border text-xs font-bold text-secondary hover:underline flex items-center gap-1"
            >
              <span>techrecruiting@abishreehr.com</span>
              <span className="material-symbols-outlined text-[14px]">mail</span>
            </a>
          </div>
          ...
          <div className="glass-card rounded-3xl p-6 flex flex-col justify-between group shadow-md border border-glass-border hover:-translate-y-1 transition-all">
            ...
            <a 
              ...
              className="cursor-pointer pt-4 mt-4 border-t border-glass-border text-xs font-bold text-tertiary hover:underline flex items-center gap-1"
            >
              <span>compliance@abishreehr.com</span>
              <span className="material-symbols-outlined text-[14px]">mail</span>
            </a>
          </div>
      ...
      <section className="relative py-24 bg-surface transition-colors duration-300 overflow-hidden">
        {/* Ambient Typographic Watermark */}
        <div className="absolute inset-0 pointer-events-none select-none overflow-hidden flex items-center justify-center z-0 opacity-[0.02] dark:opacity-[0.04] text-[8vw] font-black uppercase tracking-[0.2em] whitespace-nowrap text-on-surface">
          CORPORATE MANDATES • BENGALURU • MUMBAI • HYDERABAD
        </div>

        <div className="relative z-10 max-w-container-max mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12">
          
          {/* Left Column: Form */}
          <div className="lg:col-span-7 flex flex-col gap-8">
            <div>
              <span className="text-xs font-extrabold text-tertiary uppercase tracking-widest block mb-2">Direct Inquiry</span>
            ...
            {submitted ? (
              <div className="glass-card rounded-3xl p-10 text-center flex flex-col items-center gap-4 shadow-xl border border-primary">
                <div className="w-16 h-16 rounded-full bg-primary/10 text-primary flex items-center justify-center">
                  <span className="material-symbols-outlined text-[36px]">check_circle</span>
                </div>
                <h3 className="text-2xl font-bold text-on-surface">Consultation Request Received!</h3>
                ...
                <button
                  ...
                  className="cursor-pointer bg-primary text-on-primary text-xs font-bold px-6 py-3 rounded-xl mt-4 shadow hover:bg-primary-fixed-dim transition-all"
                >
                  Send Another Inquiry
                </button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="glass-card rounded-3xl p-8 sm:p-10 flex flex-col gap-6 shadow-xl border border-glass-border">
                    ...
                    {practiceOptions.map((opt) => {
                      ...
                      return (
                        <button
                          ...
                          className={`cursor-pointer p-2.5 rounded-xl text-xs font-bold flex items-center gap-2 transition-all text-left border ${
                            isSelected
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-bold text-on-surface">Headcount / Scope Size</label>
                    <select
                      value={headcountScope}
                      onChange={(e) => setHeadcountScope(e.target.value)}
                      className="cursor-pointer w-full bg-surface-container/60 border border-glass-border text-on-surface rounded-xl px-4 py-3 text-xs outline-none focus:border-primary font-medium"
                    >
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-bold text-on-surface">Target Hiring Timeline</label>
                    <select
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input 
                      ...
                      className="w-full bg-surface-container/60 border border-glass-border text-on-surface rounded-xl px-4 py-3 text-xs outline-none focus:border-primary font-medium placeholder:text-on-surface-variant"
                    />
                  </div>

                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-bold text-on-surface">Corporate / Work Email *</label>
                    <input 
                      type="email"
                      required
                ...
                {/* Message Field */}
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-bold text-on-surface">Mandate Details / Specific Roles Required *</label>
                  <textarea 
                    rows={4}
                    required
                    ...
                    className="w-full bg-surface-container/60 border border-glass-border text-on-surface rounded-xl px-4 py-3 text-xs outline-none focus:border-primary font-medium placeholder:text-on-surface-variant resize-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="cursor-pointer w-full bg-primary hover:bg-primary-fixed-dim text-on-primary font-bold text-sm py-4 rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50"
                >
                  {submitting ? (
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div>
              <span className="text-xs font-extrabold text-tertiary uppercase tracking-widest block mb-2">Offices & Presence</span>
            ...
            {/* Office 1 */}
            <div className="glass-card rounded-3xl p-6 flex flex-col gap-3 shadow-md border border-glass-border hover:-translate-y-1 transition-all">
              ...
              <a href="tel:+918049201100" className="cursor-pointer text-xs font-semibold text-on-surface hover:text-primary transition-colors flex items-center gap-2 pt-2 border-t border-glass-border">
            ...
            <div className="glass-card rounded-3xl p-6 flex flex-col gap-3 shadow-md border border-glass-border hover:-translate-y-1 transition-all">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-sm font-extrabold text-secondary">
              ...
              <a href="tel:+912261204400" className="cursor-pointer text-xs font-semibold text-on-surface hover:text-primary transition-colors flex items-center gap-2 pt-2 border-t border-glass-border">
                <span className="material-symbols-outlined text-secondary text-[16px]">call</span>
            ...
            <div className="glass-card rounded-3xl p-6 flex flex-col gap-3 shadow-md border border-glass-border hover:-translate-y-1 transition-all">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-sm font-extrabold text-tertiary">
              ...
              <a href="tel:+914048807700" className="cursor-pointer text-xs font-semibold text-on-surface hover:text-primary transition-colors flex items-center gap-2 pt-2 border-t border-glass-border">
                <span className="material-symbols-outlined text-secondary text-[16px]">call</span>
            ...
            {/* Operating Hours Box */}
            <div className="glass-card rounded-3xl p-6 flex flex-col gap-2 shadow-sm bg-surface-container/50">
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 flex flex-col gap-10">
          ...
          <div className="text-center">
            <span className="text-xs font-extrabold text-tertiary uppercase tracking-widest block mb-2">Clear Answers</span>
            <h2 className="text-3xl font-extrabold text-on-surface">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="cursor-pointer w-full p-5 text-left flex items-center justify-between gap-4 font-bold text-sm text-on-surface hover:text-primary transition-colors"
                  >
                    <span>{faq.q}</span>
                    <span className={`material-symbols-outlined text-[20px] transition-transform duration-300 ${isOpen ? 'rotate-180 text-primary' : 'text-on-surface-variant'}`}>
                      expand_more
                    </span>
                  </button>

                  {isOpen && (
                    <div className="px-5 pb-5 text-xs sm:text-sm text-on-surface-variant leading-relaxed border-t border-glass-border/40 pt-3 animate-in fade-in">
                      {faq.a}
                    </div>
                  )}
                </div>
